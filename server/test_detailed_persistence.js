...
async function testDetailedDatePersistence() {
  console.log('🔄 Testing detailed booking date persistence...');
  ...
  try {
    ...
    console.log('📤 PATCH request payload:', { date: newDate });
    ...
    if (updatedBooking.date === newDate) {
      ...
      console.log('🤔 Expected:', newDate, 'but got:', updatedBooking.date);
    }
