...
async function debugAddService() {
  try {
    ...
    // Override the sync function to see what's happening
    ...
    console.log('🔍 Manually calling updateServicePricesIncremental with new prices...');
    
    try {
      const incrementalResult = await GoogleSheetsService.updateServicePricesIncremental(result.prices);
      console.log('✅ Incremental update result:', incrementalResult);
    } catch (error) {
